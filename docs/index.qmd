...
sjPlot::tab_df(
  table,
  title = "<div style='text-align:center'>Table 2. Number Number of Benthic Commnity Assesement (BCA) sites sampled inside and outside M:IR areas in each stratum.</div>",
  escape = FALSE,
  show.footnote = TRUE,
  alternate.rows = TRUE,
  col.header = name,
