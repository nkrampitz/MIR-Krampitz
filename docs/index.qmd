...
```{r bleaching, fig.cap = "Figure 4. Individual Species’ Observed Bleaching Frequency Outside (NCRMP + DRM) and Inside (M:IR) areas.", fig.width=10, fig.asp=1.4, echo = FALSE}
...
```{r, echo = FALSE, fig.cap = "Figure 6. Individual Species’ Observed Diseased Frequency Outside (NCRMP + DRM) and Inside (M:IR) areas.", fig.width=10, fig.asp=1.4}
...
Groves, S., Mateski, J., Krampitz, N., Sturm, A. M., and Viehman, T. S. (2025). NCRMP benthics statistical package in R (website). R package version 1.0.0. https://github.com/MSE-NCCOS-NOAA/NCRMP_benthics

*Harper + Blondeau (2025). Mission: Iconic Reefs RVC Analysis*

NOAA Coral Reef Conservation Program. (2022b). National Coral Reef Monitoring Program (NCRMP) Benthic Community Assessment survey field protocols for U.S. Atlantic: Florida, Flower Garden Banks, Puerto Rico, and U.S. Virgin Islands--2022. NOAA Coral Reef Conservation Program. https://doi.org/0.25923/0708-8333

NOAA Coral Reef Conservation Program. (2022b). National Coral Reef Monitoring Program (NCRMP) coral demographics survey field protocols for U.S. Atlantic: Florida, Flower Garden Banks, Puerto Rico, U.S. Virgin Islands. 2022. NOAA Coral Reef Conservation Program. https://doi.org/10.25923/9a1r-m911

NOAA Coral Reef Conservation Program (CRCP). (2024a). National Coral Reef Monitoring Program (NCRMP) Benthic Community Assessment Survey Field Protocols for U.S. Atlantic: Florida, Flower Garden Banks, Puerto Rico, and U.S. Virgin Islands. NOAA Coral Reef Conservation Program. 29 pp. doi.org/10.25923/e3gf-vk84

NOAA Coral Reef Conservation Program (CRCP). (2024b). National Coral Reef Monitoring Program (NCRMP) Coral Demographics Survey Field Protocols for U.S. Atlantic: Florida, Flower Garden Banks, Puerto Rico, U.S. Virgin Islands. NOAA Coral Reef Conservation Program. 28 pp. doi.org/10.25923/hgpr-jm80
