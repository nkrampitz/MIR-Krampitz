...
# Add them to the significane table
sig_cover <- sig_cover %>%
...
```{r loop through cover plots and tab results, fig.cap="Figure 2a-e.  Hard coral and macroalgae cover estimates inside and outside M:IR areas for 2022 and 2024.  Significant difference in cover estimates in each of these areas was indicated by (*).", fig.width=9, results='asis', fig.asp=0.8, echo=FALSE}
