...
Sentence about all data using package [@Groves2025]

## Summary of Benthic Surveys

In 2022, a total of 584 surveys occurred (Table 1) across 403 sites [@Viehman2023]. In 2024, 771 surveys occured across 542 sites (Grove et al., in prep).

```{r, echo=FALSE, fig.cap = "Table 1. Still Workshopping. Trying to get it to be in R instead of as a photo but R does NOT like the multi headers"}
...
sjPlot::tab_df(
  table,
  title = "<div style='text-align:center'>Table 2. Number of benthic cover sites sampled inside and outside M:IR areas in each stratum.</div>",
  escape = FALSE,
  show.footnote = TRUE,
  alternate.rows = TRUE,
  col.header = name,
...
```{r overall Density,  fig.cap = "Figure 4. Caption needed here!", fig.width=9, fig.asp=1.2, echo = FALSE}
...
```{r overall Old_Mort, fig.cap = "Figure 5. Caption needed here!", fig.width=9, fig.asp=1.2, echo = FALSE}
###Adding species names and starring MIR species
...
```{r overall Max_Dim, fig.cap = "Figure 6. Caption needed here too!", fig.width=9, fig.asp=1.2, echo = FALSE}
...
```{r bleaching, fig.cap = "Figure 7. Individual Species’ Observed Bleaching Frequency Outside (NCRMP + DRM) and Inside (M:IR) areas.", fig.width=10, fig.asp=1.4, echo = FALSE}
...
```{r, echo = FALSE, fig.cap = "Figure 8. Individual Species’ Observed Diseased Frequency Outside (NCRMP + DRM) and Inside (M:IR) areas.", fig.width=10, fig.asp=1.4}
